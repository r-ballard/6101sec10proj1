...
In this section we conduct Multiple Correspondent Analysis on the Breyers icecream data, specifically engineering features from a one-hot encoded matrix of ingredient contents for the icecream. With review Star rating as the response variable. Here we attempt to answer our research question, "Can we identify ingredients which correlate with Ratings?"
