...
```{r high-rated-ingredients, results='markup'}
...
```{r pred-chocolate, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
  Name = "Chocolate",
  HAS_CARAMEL = 0,
...
```{r pred-choco-vanilla, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r pred-choco-cara, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r pred-choco-org, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r pred-high-rated, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
  Name = "Chocolate/Vanilla",
  HAS_CARAMEL = 0,
...
```{r high-rated-choco, results='markup'}
...
```{r high-rated-fruit, results='markup'}
