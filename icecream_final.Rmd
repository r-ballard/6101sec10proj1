...
```{r measures-variation, echo=FALSE}
...
```{r describe-data, message=FALSE, warning=FALSE, results='markup'}
loadPkg("Hmisc")
...
```{r breyers-highrated, echo=FALSE, results='markup'}
...
```{r breyers-lowrated, echo=FALSE, results='markup'}
...
```{r breyers-central-tendency, echo=FALSE}
...
```{r breyers-measures-variation, echo=FALSE}
...
```{r summary-brand, results='markup'}
...
```{r plot-distribution, results='markup'}
...
```{r top-rated-ingredients, results='markup'}
...
```{r new-choco-van, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r new-cara-choco, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r new-choco-org, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
...
```{r best-new-prod, results='markup'}
new_data <- data.frame(
  Brand = "breyers",
  Name = "Chocolate/Vanilla",
  HAS_CARAMEL = 0,
...
```{r breyers-high-choco, results='markup'}
...
```{r breyers-high-fruit, results='markup'}
...
```{r breyers-high-org, results='markup'}
...
```{r breyers-bar-products, results='markup'}
...
```{r best-prod-ingredients, results='markup'}
