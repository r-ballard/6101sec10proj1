...
#TODO, remove comment. This unzip is necessary but slows down knit operation 
...
* __HAS_VANILLA__ - `products` records with the string `VANILLA` in their `Ingredients` field
* __HAS_ORGANIC__ - `products` records with the string `ORGANIC` in their `Ingredients` field
* __HAS_CARAMEL__ - `products` records with the string `VANILLA` in their `Ingredients` field
