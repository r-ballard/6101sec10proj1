...
chocvio <- ggplot(productreview,aes(HAS_CHOCOLATE,Stars)) +
  ...
  scale_fill_manual(values=c("grey","chocolate4")) +
    labs(title="Distribution of Ratings For Icecreams \nBy Contains Chocolate Indicator",
       x="Contains Chocolate",
       y="Rating") +
    theme(plot.title = element_text(hjust = 0.5)) +
    guides(fill=guide_legend(title="chocolate ind."))
...
fruitvio <- ggplot(productreview,aes(HAS_FRUIT,Stars)) +
  ...
  scale_fill_manual(values=c("grey","deeppink")) +
    labs(title="Distn of Ratings For Icecreams \nBy Contains Fruit Indicator",
       ...
       y="Rating") +
    theme(plot.title = element_text(hjust = 0.5)) +
    guides(fill=guide_legend(title="fruit ind."))
...
organicvio <- ggplot(productreview,aes(HAS_ORGANIC,Stars)) +
  ...
  scale_fill_manual(values=c("grey","chartreuse3")) +
    labs(title="Distn of Ratings For Icecreams \nBy Contains Organic Indicator",
       ...
       y="Rating") +
    theme(plot.title = element_text(hjust = 0.5)) +
    guides(fill=guide_legend(title="organic ind."))
...
caramelvio <- ggplot(productreview,aes(HAS_CARAMEL,Stars)) +
  ...
  scale_fill_manual(values=c("grey","darkgoldenrod4")) +
    labs(title="Distn of Ratings For Icecreams \nBy Contains Caramel Indicator",
       ...
       y="Rating") +
    theme(plot.title = element_text(hjust = 0.5)) +
    guides(fill=guide_legend(title="caramel ind."))
...
```
Above are mosaic plots for proportions of star ratings for each ingredient indicator in the product-review data.
Now that we have conducted various exploratory analysis, there are a handful of hypotheses we would like to resolve by applying statistical testing to the dataset.

```{r ingredientanova}
chisq.test(choc_contingency_table)
chisq.test(fruit_contingency_table)
chisq.test(organic_contingency_table)
chisq.test(caramel_contingency_table)
```
