...
#TODO: DELETE, write statement, don't need to write raw
#write.csv(productreview, "merged_data.csv", row.names=FALSE)
```
...
products$IS_BAR <- as.factor(as.integer(grepl(pattern = "BAR", x = products$name) | 
...
#### For this project we will be addressing the question: What are the most common factors stated in the customer reviews that affect the product ratings? So that businesses can either improve on lower rated products, or create new products keeping customer feedback in mind.
...
bj7_top <- subset(productreview, key == "7_bj")
...
```{r, echo=FALSE, results='markup'}
bj31_top <- subset(productreview, key == "31_bj")
...
```{r, echo=FALSE, results='markup'}
bj_low <- subset(productreview, key == "50_bj")
...
```{r, echo=FALSE, results='markup'}
hd14_top <- subset(productreview, key == "14_hd")
...
```{r, echo=FALSE, results='markup'}
hd31_top <- subset(productreview, key == "31_hd")
...
```{r, echo=FALSE, results='markup'}
hd43_top <- subset(productreview, key == "43_hd")
...
```{r, echo=FALSE, results='markup'}
hd44_top <- subset(productreview, key == "44_hd")
...
```{r, echo=FALSE, results='markup'}
hd63_top <- subset(productreview, key == "63_hd")
...
```{r, echo=FALSE, results='markup'}
hd_low <- subset(productreview, key == "66_hd")
...
```{r, echo=FALSE, results='markup'}
tal2_top <- subset(productreview, key == "2_talenti")
...
```{r, echo=FALSE, results='markup'}
tal5_top <- subset(productreview, key == "5_talenti")
...
```{r, echo=FALSE, results='markup'}
tal11_top <- subset(productreview, key == "11_talenti")
...
```{r, echo=FALSE, results='markup'}
tal30_top <- subset(productreview, key == "30_talenti")
...
```{r, echo=FALSE, results='markup'}
tal_low <- subset(productreview, key == "9_talenti")
...
```{r, echo=FALSE, results='markup'}
breyers_top <- subset(productreview, key == "41_breyers")
...
```{r, echo=FALSE, results='markup'}
breyers_low <- subset(productreview, key == "66_breyers")
