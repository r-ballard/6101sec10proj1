...
#productreview <-productreview[productreview$Brand=="breyers",]
```
...
products_brey <- products[products$Brand=='breyers',]

#sortorder
ratingorder <- products_brey[order(products_brey$Rating, decreasing = TRUE),"ProductID"]


ggplot(products_brey, aes(x=ProductID, y=Rating)) +
