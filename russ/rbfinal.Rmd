...
testsums <- aggregate(.~traintest,ingredindicator,sum)
...
mcamass = mca(ingred_training)

mca2 = MCA(ingred_test, graph = FALSE)

newtest1 <- predict.MCA(object = mca1,
            newdata = ingred_test)

newtest2 <- predict.MCA(object = mca2,
            newdata = ingred_training)
