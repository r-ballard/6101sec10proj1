...
#todo, remove comment if it breaks
...
plot(productreview_training$Dim_4, productreview_training$Dim_3, col=productreview_training$Stars)


str(productreview_training)
str(productreview_test)

#subset=train
#names(productreview_training)
...
productreview_test <- left_join(productreview_test,
                                   ingred_test.mcadim %>% select('Dim 1',
                                                                     'Dim 2',
                                                                     'Dim 3',
                                                                     'Dim 4',
                                                                     'Dim 5',
