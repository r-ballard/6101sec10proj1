...
zippath <- file.path(projwd, datadir, raw, zipf, fsep="/")
outpath <-file.path(projwd, datadir, raw, outf, fsep="/") 
...
prodcombpath <- file.path(projwd, datadir, outf, "combined/products.csv")
