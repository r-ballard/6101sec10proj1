...
```{r, echo=TRUE}
products$zRating = scale(products$Rating)
```

```{r results='markup'}
mean(products$zRating, na.rm = TRUE)
sd(products$zRating, na.rm = TRUE)

summary(products$zRating)
```
